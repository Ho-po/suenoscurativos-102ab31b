...
export const OrderBumps = () => {
  ...
  return (
    <section className="py-10 sm:py-12 md:py-16 px-4 bg-secondary">
      <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
        <div className="text-center mb-6 sm:mb-8">
          <p className="text-base sm:text-lg text-primary font-medium">¡Espera! Ofertas exclusivas solo en este momento</p>
        </div>

        {/* Order Bump 1 - Audios */}
        <div
          className={`bg-card rounded-xl sm:rounded-2xl border-2 transition-all duration-300 overflow-hidden ${
            bump1Selected ? "border-primary shadow-gold" : "border-primary/30"
          }`}
        >
          <div className="gradient-gold px-4 sm:px-6 py-2 sm:py-3">
            <p className="text-primary-foreground font-bold text-xs sm:text-sm uppercase tracking-wide">
          ...
          <div className="p-4 sm:p-6">
            <div className="flex items-start gap-3 sm:gap-4">
              <Checkbox
                ...
                className="mt-1 h-5 w-5 sm:h-6 sm:w-6 border-2 border-primary data-[state=checked]:bg-primary"
              />
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-primary font-bold">Solo $4.90 USD</p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3 text-xs sm:text-sm">
                  <span className="flex items-center gap-1 text-muted-foreground">
                    <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" /> Más de 2 horas de audio
                  </span>
                  <span className="flex items-center gap-1 text-muted-foreground">
                    <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" /> Descarga inmediata
                  </span>
                  <span className="flex items-center gap-1 text-muted-foreground">
                    <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" /> Acceso de por vida
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-primary font-bold">Solo $3.90 USD</p>
                  </div>
                </div>
                <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3 text-xs sm:text-sm">
                  <span className="flex items-center gap-1 text-muted-foreground">
                    <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" /> Guía paso a paso
                  </span>
                  <span className="flex items-center gap-1 text-muted-foreground">
                    <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" /> Ejercicios diarios
                  </span>
                  <span className="flex items-center gap-1 text-muted-foreground">
                    <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" /> Afirmaciones incluidas
                  </span>
                </div>
              </div>
            </div>
